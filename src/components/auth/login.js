                ...
                <form onSubmit={login} className="width-85-percent">
                    <div className="full-width bottom-margin-15">
                        <InputGroup className="input-group full-width height-55 bottom-margin-15 border-radius-10">
                            <input type="email" name="email_input" onChange={onChange} value={user.email} className={`${user.email !== undefined && user.email !== "" ? "with-data" : ""} height-55 smooth`} required autoComplete="new-password" />
                    ...
                    <button type="submit" className="full-width bottom-margin-30 left-padding-30 right-padding-30 border-box border-radius-10 mustard height-55 cursor-pointer white-color size-pointnine-rem bold display-flex align-items-center justify-center">
                        {userStore.loggingIn ?
