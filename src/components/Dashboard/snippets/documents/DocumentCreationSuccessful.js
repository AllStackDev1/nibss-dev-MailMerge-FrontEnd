...
const DocumentCreationSuccessful = ({ setUploadingDocument }) => {
    return (
        <div className="full-height left-padding-80 right-padding-80 display-flex flex-direction-column justify-center align-items-center">
            ...
            <button onClick={() => setUploadingDocument(false)} type="button" className="left-padding-30 right-padding-30 height-50 no-shrink width-300 mustard border-radius-2 display-flex align-items-center justify-center">
