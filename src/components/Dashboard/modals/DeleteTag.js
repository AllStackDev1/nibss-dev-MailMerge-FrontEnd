...
// Delete tag modal
const DeleteTag = ({ onSubmit, deleting, closeModal }) => {
    return (
        <div onClick={e => e.stopPropagation()} className="width-40-percent" data-test='delete-tag-component'>
            <div className="display-flex full-width flex-direction-column justify-center bottom-margin-30 text-center">
                ...
                <p className="white-color bold">Delete Tag</p>
            </div>
            <div className="action-modal no-select white full-width border-box left-padding-50 right-padding-50 bottom-padding-50 border-radius-10 top-padding-50 text-center">
                ...
                <p className="size-one-rem bottom-margin-50">Are you sure you want to delete this tag?</p>
                <div className="full-width display-flex space-between">
                    <button
                        onClick={onSubmit}
                        type="button"
                        disabled={deleting?._id !== undefined}
                        className={`width-200 
                            no-border 
                            left-padding-30 
                            right-padding-30 
