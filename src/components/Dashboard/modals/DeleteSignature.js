        ...
        <div onClick={e => e.stopPropagation()} className="width-40-percent">
            ...
            <div className="action-modal no-select white full-width border-box left-padding-50 right-padding-50 bottom-padding-50 border-radius-10 top-padding-50 text-center">
                ...
                <div className="full-width display-flex space-between">
                    <button onClick={onSubmit} type="button" disabled={deleting !== undefined} className="width-200 no-border left-padding-30 right-padding-30 border-box mustard height-45 cursor-pointer white-color size-pointeight-rem bold display-flex align-items-center justify-center">
                        {deleting !== undefined ?
                            <div className="lds-ring"><div></div><div></div><div></div><div></div></div>
                            :
                            'Yes'}
                    </button>
                    <button onClick={closeModal} type="button" disabled={deleting !== undefined} className="width-200 no-border left-padding-30 right-padding-30 border-box red height-45 cursor-pointer white-color size-pointeight-rem bold display-flex align-items-center justify-center">
                        No
                    </button>
                </div>
            </div>
